# Tanker SDK (datastore dexie memory)

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![NPM Package](https://img.shields.io/npm/v/@tanker/datastore-dexie-memory.svg)](http://npmjs.org/package/@tanker/datastore-dexie-memory)
![Minified Size](https://img.shields.io/bundlephobia/minzip/@tanker/datastore-dexie-memory.svg)
