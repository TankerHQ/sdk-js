...
const Spinner = ({ color, size, ...props }: {color: string, size: number}) => (
  <Svg viewBox="0 0 10 10" width={size} height={size} aria-label="Loading..." tabIndex="0" role="progressbar" {...props}>
    <Wrapper>
