...
export function encryptAEAD(key: Uint8Array, iv: Uint8Array, plaintext: Uint8Array, associatedData: Uint8Array | null = null): Uint8Array {
  return sodium.crypto_aead_xchacha20poly1305_ietf_encrypt(plaintext, associatedData, null, iv, key);
}

export function decryptAEAD(key: Uint8Array, iv: Uint8Array, ciphertext: Uint8Array, associatedData: Uint8Array | null = null): Uint8Array {
