...
describe('BlockGenerator', () => {
  ...
  it('order stuff correctly for UserGroupCreationV1 sign data', async () => {
    ...
    const gotSignData = getUserGroupV1CreationBlockSignData(record);
  ...
  it('order stuff correctly for UserGroupCreationV2 sign data', async () => {
    ...
    const gotSignData = getUserGroupV2CreationBlockSignData(record);
  ...
  it('can create a user group', async () => {
    ...
    const signData = getUserGroupV2CreationBlockSignData(record);
  ...
  it('order stuff correctly for UserGroupAdditionV1 sign data', async () => {
    ...
    const gotSignData = getUserGroupV1AdditionBlockSignData(record);
