...
describe('TrustchainVerifier', () => {
  ...
  describe('device creation', () => {
    // The last reset field that should be a zero array is tested in the serialization
    // FIXME: this should also be tested at this level
    ...
    // TODO: write & implement: 'should reject a deviceCreationV3 if the userPublicKey is already used'
  ...
  describe('device revocation', () => {
    ...
    // TODO: write & implement: 'should reject a revocation v2 with an existing PublicEncryptionKey from a device creation'

    // TODO: write & implement: 'should reject a revocation v2 with an existing PublicEncryptionKey from another revocation'
