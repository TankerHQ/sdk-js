...
export default class TrustchainBuilder {
  ...
  async addUserGroupAddition(from: GeneratorUserResult, group: GeneratorUserGroupResult, members: Array<string>, provisionalMembers?: Array<FullPublicProvisionalIdentity>): Promise<GeneratorUserGroupAdditionResult> {
