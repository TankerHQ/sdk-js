...
import { type ProvisionalIdentityKeyPairsWithId } from '../Session/KeySafe';
...
export default class UserStore {
  ...
  async applyProvisionalIdentityClaims(entries: Array<VerifiedProvisionalIdentityClaim>): Promise<Array<ProvisionalIdentityKeyPairsWithId>> {
