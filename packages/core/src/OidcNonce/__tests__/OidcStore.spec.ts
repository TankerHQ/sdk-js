...
import Storage from '../../UnauthSession/UnauthSessionStorage';
...
describe('OidcStore', () => {
  ...
  beforeEach(async () => {
    ...
    const oidcNonceStoreConfig = { dbName, ...dataStoreConfig, schemas: OidcStore.schemas, defaultVersion: Storage.defaultVersion };
