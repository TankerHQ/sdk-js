...
export class Client extends EventEmitter {
  ...
  async getLastUserKey(trustchainId: Uint8Array, deviceId: b64string): Promise<?EncryptedUserKey> {
    ...
    // warning: because of a mis-feature in gorm, instead of getting null in
    // these two fields, we get an empty string, but we are lucky because empty
    // string is a falsy, so this code works with both null and empty string!
    // thank you js, you saved my life
    // EDIT: is it still true with gorm replaced by go-pg?
