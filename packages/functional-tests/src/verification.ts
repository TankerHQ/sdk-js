...
async function setOidcTestNonce(tanker: Tanker, nonce: string): Promise<void> {
  // eslint-disable-next-line no-underscore-dangle
  await tanker._initUnauthSession();
  // eslint-disable-next-line no-underscore-dangle
  tanker._unauthSession!.setOidcTestNonce(nonce);
}
    ...
    describe('verification by oidc id token', () => {
      describe('using Google', () => {
        ...
        it('fails to register when nonce was not generated by tanker', async () => {
          ...
          await setOidcTestNonce(bobLaptop, '');
          await expect(bobLaptop.registerIdentity({ oidcIdToken: martineIdToken })).to.be.rejectedWith(errors.InvalidArgument);
          await setOidcTestNonce(bobLaptop, 'a');
          await expect(bobLaptop.registerIdentity({ oidcIdToken: martineIdToken })).to.be.rejectedWith(errors.InvalidArgument);
        });
      ...
      describe('using Pro Sante Connect', () => {
        const pscIdToken = 'eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJjaDNLZkFqOXZhX2tUZ2xGY01'
          ...
          + 'odHRwczovL2F1dGguYmFzLmVzdy5lc2FudGUuZ291di5mci9hdXRoL3JlYWxtcy9lc2FudGUtd2FsbGV0IiwiYXVkIjo'
          + 'iZG9jdG9saWItZGV2Iiwic3ViIjoiZjo1NTBkYzFjOC1kOTdiLTRiMWUtYWM4Yy04ZWI0NDcxY2Y5ZGQ6QU5TMjAyMjA'
          + 'zMzEwOTAzNDYiLCJ0eXAiOiJJRCIsImF6cCI6ImRvY3RvbGliLWRldiIsIm5vbmNlIjoib2w0YmtycDRpWkFTc2tEY1Z'
          + 'neG5RWnZhcjRUMi96Y21DR0VJZFB4NC9CWT0iLCJzZXNzaW9uX3N0YXRlIjoiZDczYjRkZjUtNzkzMS00OTg0LWEwNDc'
          + 'tNjQxNzA4MDE2MTA1IiwiYXRfaGFzaCI6IktEcm1UVElQOWJhWExqSC1PalJVNEEiLCJzaWQiOiJkNzNiNGRmNS03OTM'
          + 'xLTQ5ODQtYTA0Ny02NDE3MDgwMTYxMDUiLCJhY3IiOiJlaWRhczEiLCJlbWFpbF92ZXJpZmllZCI6ZmFsc2UsInByZWZ'
          + 'lcnJlZF91c2VybmFtZSI6IkFOUzIwMjIwMzMxMDkwMzQ2In0.ZNrxshN13FBHWhMvzeVy_O7e5TUd-JkDcvoOM_pvwHz'
          + '8Y_lDkR1q1fcbFv6ktSlfklli01nhcR8OGvamSBumTc9VaODt1R2kQilR8EUNnE0plUsomx6rnlHHzCj-UpiKPfGCk_d'
          + 's2xPzKNp98CPlcSrOg8eyAjA2qWuGe4B89nNjm_88g7tr2BqJ8zKcfEqV1dxVprAZ-7wgBxCxicQucb4hHlRIOWi5CPI'
          + '35eEVKL7HyUqN-nbMmsIBekPU27zjRwYPqjH63u3Le0YCntrZBwWzsW0g33B-GPSo9GIeyFtoCm4CuybSiMhwEBriltD'
          + 'PJbCkPdmOQR37U1keTO1hAw';
