...
import { makePrefix, AppHelper, admindUrl, appdUrl, trustchaindUrl, idToken, oidcSettings, benchmarkSettings } from './helpers';
...
export function generateFunctionalTests(
  ...
  if (!admindUrl || !appdUrl || !idToken || !oidcSettings || !trustchaindUrl) {
...
export { makePrefix, AppHelper, admindUrl, appdUrl, idToken, oidcSettings, benchmarkSettings, trustchaindUrl };
